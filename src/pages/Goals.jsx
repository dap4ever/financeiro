        ...
        <div>
            <div className="flex justify-between items-center mb-6">
             ...
             {isFormOpen && (
                <div className="card mb-8">
                    <h3 className="card-title mb-4" style={{ fontSize: 'var(--font-size-lg)', color: 'var(--text-primary)' }}>Adicionar Meta</h3>
            ...
            <div className="dashboard-grid">
                {goals.map((goal) => {
                    ...
                    return (
                        <div key={goal.id} className="card flex flex-col justify-between" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            <div>
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-3">
                                        <div style={{ backgroundColor: 'var(--bg-hover)', padding: 'var(--spacing-2)', borderRadius: 'var(--radius-md)', color: 'var(--accent-secondary)' }}>
                                            <Target size={24} />
                                        </div>
                                        <div>
